...
set GCC_ARM_PATH=C:\PROGRA~2\GNUTOO~1\4947E~1.920\bin


set PATH=C:\Windows;C:\Windows\System32;%NODE_PATH%;%DFU_FILES_PATH%;%SPARK_CLI_PATH%;%GCC_ARM_PATH%;
...
echo "*************************************" >> myoutput.txt 2>&1
echo "arm-none-eabi-gcc --version"           >> myoutput.txt 2>&1
echo "*************************************" >> myoutput.txt 2>&1
arm-none-eabi-gcc --version                  >> myoutput.txt 2>&1
echo "*************************************" >> myoutput.txt 2>&1
...
echo "*************************************" >> myoutput.txt 2>&1
echo "spark flash --usb spkbin\core-firmware.bin"  >> myoutput.txt 2>&1
echo "*************************************" >> myoutput.txt 2>&1
spark flash --usb spkbin\core-firmware.bin        >> myoutput.txt 2>&1
echo "*************************************" >> myoutput.txt 2>&1
...
rem spark must be last or in its own batch file as it kills the batch program
